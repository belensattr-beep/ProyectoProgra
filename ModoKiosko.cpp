...
#include <Arduino.h> // Necesario para String, millis, etc.
...
void ModoKiosko::ejecutar() {
    ...
    if (estado == ESPERANDO_TIPO) {
        if (teclado.leerTipoNoBloqueante(tipo, lcd)) {
            Tarjeta* t = nullptr;
...
// Función auxiliar: Asegúrate de que tenga el "ModoKiosko::" antes del nombre
